...
export function TripLogisticsManager({ trip, data }: { trip: Trip; data: TripOperationsData }) {
  ...
  return (
    <div className="admin-sections">
      ...
      <form className="form-card" method="post" onSubmit={(event) => submit(event, "room-assignment", assignRoomAction)}>
      ...
      <form className="form-card" method="post" onSubmit={(event) => submit(event, "itinerary", addItineraryItemAction)}>
